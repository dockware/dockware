...
$ docker run --rm -p 80:80 dockware/play:6.5.8.10

# use another php version
$ docker run --rm -p 80:80 --env PHP_VERSION=7.2 dockware/play:6.5.8.10
```
...
|---|---| --- |
| PHP_VERSION  | 8.4 | Switch to any of the installed PHP versions:  8.3, 8.2, 8.1,         |
