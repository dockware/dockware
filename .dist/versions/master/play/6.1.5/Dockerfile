...
#
FROM ubuntu:18.04
LABEL title="Dockware play:6.1.5" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://www.shopware.com/de/Download/redirect/version/sw6/file/install_6.1.5_1585830011.zip -qq -O /var/www/shopware.zip \
