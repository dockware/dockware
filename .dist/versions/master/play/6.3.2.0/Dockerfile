...
#
FROM ubuntu:18.04
LABEL title="Dockware play:6.3.2.0" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://www.shopware.com/de/Download/redirect/version/sw6/file/install_v6.3.2.0_979aa4e7fd33d75e33ce1dc58b65616b18b702d2.zip -qq -O /var/www/shopware.zip \
