...
$ docker run --rm -p 80:80 dockware/play:5.7.19

# use another php version
$ docker run --rm -p 80:80 --env PHP_VERSION=7.2 dockware/play:5.7.19
```
...
|---|---| --- |
| PHP_VERSION  | 8.4 | Switch to any of the installed PHP versions:  8.3, 8.2, 8.1, 8.0, 7.4, 7.3, 7.2,     |
