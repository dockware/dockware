...
$ docker run --rm -p 80:80 dockware/play:5.2.21

# use another php version
$ docker run --rm -p 80:80 --env PHP_VERSION=7.2 dockware/play:5.2.21
```
...
|---|---| --- |
| PHP_VERSION  | 8.3 | Switch to any of the installed PHP versions: 8.3,        7.0, 5.6,  |
