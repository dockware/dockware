...
#
FROM ubuntu:18.04
LABEL title="Dockware play:6.4.2.0" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://www.shopware.com/en/Download/redirect/version/sw6/file/install_v6.4.2.0_9d00ae28899e87f520bfeb2d5a652cc329c214f9.zip -qq -O /var/www/shopware.zip \
