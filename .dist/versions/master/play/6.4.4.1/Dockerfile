...
#
FROM ubuntu:18.04
LABEL title="Dockware play:6.4.4.1" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://www.shopware.com/en/Download/redirect/version/sw6/file/install_v6.4.4.1_ec67114dc06e7c6998f5508f9119684037e2cb74.zip -qq -O /var/www/shopware.zip \
