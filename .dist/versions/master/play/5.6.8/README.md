...
$ docker run --rm -p 80:80 dockware/play:5.6.8

# use another php version
$ docker run --rm -p 80:80 --env PHP_VERSION=7.2 dockware/play:5.6.8
```
...
|---|---| --- |
| PHP_VERSION  | 8.0 | Switch to any of the installed PHP versions:  7.4, 7.3, 7.2, 7.1, 7.0, 5.6,  |
