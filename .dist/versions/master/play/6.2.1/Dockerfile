...
#
FROM ubuntu:18.04
LABEL title="Dockware play:6.2.1" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://www.shopware.com/en/Download/redirect/version/sw6/file/install_6.2.1_1592219982.zip -qq -O /var/www/shopware.zip \
