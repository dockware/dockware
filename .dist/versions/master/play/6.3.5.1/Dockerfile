...
#
FROM ubuntu:18.04
LABEL title="Dockware play:6.3.5.1" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://www.shopware.com/de/Download/redirect/version/sw6/file/install_v6.3.5.1_b2d5d91f1f2189b0112601b0cfd65073b2d12dd4.zip -qq -O /var/www/shopware.zip \
