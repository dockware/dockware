...
#
FROM ubuntu:18.04
LABEL title="Dockware play:6.4.13.0" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://releases.shopware.com/sw6/install_v6.4.13.0_103dc0188e0f33fb5fd77796488284b56c7073bb.zip -qq -O /var/www/shopware.zip \
