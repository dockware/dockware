...
#
FROM ubuntu:18.04
LABEL title="Dockware play:6.4.6.1" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://www.shopware.com/en/Download/redirect/version/sw6/file/install_v6.4.6.1_071485b1e76c9d6eceddafcd30b4812588ea925a.zip -qq -O /var/www/shopware.zip \
