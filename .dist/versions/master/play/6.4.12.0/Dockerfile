...
#
FROM ubuntu:18.04
LABEL title="Dockware play:6.4.12.0" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://releases.shopware.com/sw6/install_v6.4.12.0_52d0fda063a54b12b5bec5010c6cef8dc7a7e1b5.zip -qq -O /var/www/shopware.zip \
