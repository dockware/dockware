...
#
FROM ubuntu:18.04
LABEL title="Dockware play:6.4.3.1" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://www.shopware.com/en/Download/redirect/version/sw6/file/install_v6.4.3.1_fab7f6f320882e5ed742e09f8a7794dc55f727c9.zip -qq -O /var/www/shopware.zip \
