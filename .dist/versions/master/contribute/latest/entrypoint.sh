...
echo ""
echo "*******************************************************"
echo "** DOCKWARE IMAGE: contribute"
echo "** Tag: latest"
echo "** Version: 1.3.5-beta"
...
echo ""
echo "WOHOOO, dockware/contribute:latest IS READY :) - let's get started"
echo "-----------------------------------------------------"
...
echo ""
echo "HOW TO CONTRIBUTE?! Please see this link for further details:"
