...
$ docker run --rm -p 80:80 dockware/dev:6.4.3.1-m1-test

# use another php version
$ docker run --rm -p 80:80 --env PHP_VERSION=7.2 dockware/dev:6.4.3.1-m1-test
```
...
|---|---| --- |
| PHP_VERSION  | 8.0 | Switch to any of the installed PHP versions: 8.0, 7.4,       |
...
```ruby
dockware:
    image: dockware/dev:6.4.3.1-m1-test
