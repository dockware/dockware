...
$ docker run --rm -p 80:80 dockware/dev:6.5.0.0-trunk

# use another php version
$ docker run --rm -p 80:80 --env PHP_VERSION=7.2 dockware/dev:6.5.0.0-trunk
```
...
|---|---| --- |
| PHP_VERSION  | 8.2 | Switch to any of the installed PHP versions: 8.2, 8.1, 8.0, 7.4,       |
...
```ruby
dockware:
    image: dockware/dev:6.5.0.0-trunk
