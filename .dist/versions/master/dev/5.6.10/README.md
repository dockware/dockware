...
$ docker run --rm -p 80:80 dockware/dev:5.6.10

# use another php version
$ docker run --rm -p 80:80 --env PHP_VERSION=7.2 dockware/dev:5.6.10
```
...
|---|---| --- |
| PHP_VERSION  | 8.3 | Switch to any of the installed PHP versions: 8.3, 8.2, 8.1,  7.4, 7.3, 7.2,     |
