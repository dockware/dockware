...
#
FROM ubuntu:18.04
LABEL title="Dockware dev:5.7.12" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget http://releases.s3.shopware.com.s3.amazonaws.com/install_5.7.12_af3e708cad4b39f80274be8b057dca82dbb318d9.zip -qq -O /var/www/shopware.zip \
