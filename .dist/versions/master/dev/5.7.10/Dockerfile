...
#
FROM ubuntu:18.04
LABEL title="Dockware dev:5.7.10" \
      version="1.5.3" \
...
RUN service php8.0-fpm stop > /dev/null 2>&1 && \
    service php8.0-fpm start && \
    sudo update-alternatives --set php /usr/bin/php8.0 > /dev/null 2>&1
...
RUN rm -rf /var/www/html/* \
    && wget https://www.shopware.com/en/Download/redirect/version/sw5/file/install_5.7.10_b384fb333ede4119d312075746273e2ec180e117.zip -qq -O /var/www/shopware.zip \
