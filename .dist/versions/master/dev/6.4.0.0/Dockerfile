...
#
FROM ubuntu:18.04
LABEL title="Dockware dev:6.4.0.0" \
      version="1.5.3" \
...
RUN rm -rf /var/www/html/* \
    && wget --no-check-certificate https://www.shopware.com/en/Download/redirect/version/sw6/file/install_v6.4.0.0_53c7ba74a3d915e6e8d045b59df1ae2922df15da.zip -qq -O /var/www/shopware.zip \
