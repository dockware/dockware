...
$ docker run --rm -p 80:80 dockware/essentials:test-php8.1

# use another php version
$ docker run --rm -p 80:80 --env PHP_VERSION=7.2 dockware/essentials:test-php8.1
```
...
|---|---| --- |
| PHP_VERSION  | 8.2 | Switch to any of the installed PHP versions: 8.2, 8.1,         |
